...
@SEXI_MOD.on_message(filters.private & filters.command(["help"]))
...
@SEXI_MOD.on_message(filters.private & filters.command(["start"]))
async def start(bot, update):
    if Config.SEXI_MOD_UPDATES_CHANNEL is not None:
