...
async def youtube_dl_call_back(bot, update):
    try:
        ...
        save_ytdl_json_path = Config.SEXI_MOD_DOWNLOAD_LOCATION + "/" + str(update.from_user.id) + ".json"
    ...
    await update.message.edit(text=Translation.SEXI_MOD_DOWNLOAD_START)
    description = Translation.SEXI_MOD_CUSTOM_CAPTION_UL_FILE
    ...
    if file_size == 0:
        ...
        asyncio.create_task(clendir(tmp_directory_for_each_user))
        return
    await update.message.edit(text=Translation.SEXI_MOD_UPLOAD_START)
    try:
        ...
        if tg_send_type == "audio":
            ...
            progress_args=(Translation.SEXI_MOD_UPLOAD_START, update.message, start_time))
            ...
            reply_to_message_id=update.message.reply_to_message.id,
            progress=progress_for_pyrogram,
            progress_args=(Translation.SEXI_MOD_UPLOAD_START,
        ...
        await bot.edit_message_text(text=Translation.SEXI_MOD_ERROR.format(e),
